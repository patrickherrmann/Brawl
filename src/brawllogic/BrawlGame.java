...
public class BrawlGame {
    ...
    public BrawlGame(Map<Player, Fighter> fighters) {
        ...
        for (Player player : Player.values()) {
            ...
            bases.add(new Base(new Card(player, CardType.BASE)));
            discards.put(player, new Stack());
        }
    }
    
    public void draw(Player player) throws GameplayException {
        ...
        if (deck.isEmpty())
            throw new GameplayException("No cards left to draw.");
    ...
    public void tryMove(Player player, BasePosition basePosition, Player side) throws GameplayException {
        
        Stack<Card> discard = discards.get(player);
        
        if (discard.isEmpty())
            throw new GameplayException("You must draw a card before you can play.");
